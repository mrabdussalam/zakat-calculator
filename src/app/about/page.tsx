                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="rounded-xl bg-white p-6 shadow-sm border border-gray-100">
                        <div className="space-y-4">
                            <h2 className="text-xl font-medium tracking-tight text-gray-900 mb-2">{t('about.designPrinciples')}</h2>
                            <ul className="space-y-8 text-gray-600">
                                <li className="flex items-start gap-4">
                                    <ShieldIcon size={20} className="flex-none mt-0.5 text-gray-700" />
                                    <div className="space-y-1">
                                        <p className="text-sm font-medium text-gray-800">{t('about.principles.privacy.title')}</p>
                                        <p className="text-sm">{t('about.principles.privacy.description')}</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                                    <StackIcon size={20} className="flex-none mt-0.5 text-gray-700" />
                                    <div className="space-y-1">
                                        <p className="text-sm font-medium text-gray-800">{t('about.principles.comprehensive.title')}</p>
                                        <p className="text-sm">{t('about.principles.comprehensive.description')}</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                                    <FeedbackIcon size={20} className="flex-none mt-0.5 text-gray-700" />
                                    <div className="space-y-1">
                                        <p className="text-sm font-medium text-gray-800">{t('about.principles.feedback.title')}</p>
                                        <p className="text-sm">{t('about.principles.feedback.description')}</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                                    <SummaryIcon size={20} className="flex-none mt-0.5 text-gray-700" />
                                    <div className="space-y-1">
                                        <p className="text-sm font-medium text-gray-800">{t('about.principles.summaries.title')}</p>
                                        <p className="text-sm">{t('about.principles.summaries.description')}</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <motion.div variants={itemVariants} className="rounded-xl bg-white p-6 shadow-sm border border-gray-100 space-y-3">
                        <h2 className="text-xl font-medium tracking-tight text-gray-900">{t('about.methodology')}</h2>
                        <p className="text-sm text-gray-600">
                            {t('about.methodologyText1')}
                        </p>
                        <p className="text-sm text-gray-600 mt-2">
                            {t.rich('about.methodologyText2', {
                                link: (chunks) => (
                                    <a
                                        href="https://www.amazon.com/Simple-Zakat-Guide-Understand-Calculate/dp/0996519246/ref=sr_1_1?crid=2O6J3RO9HZUHX&dib=eyJ2IjoiMSJ9.y0oTd-gjIwGd-BJ1eaBNRHNRZ6n6O1-Dyetc_H4MHA_GjHj071QN20LucGBJIEps.PYwdoDL-LTCWVcOJHab4ob-L9zPrDHlwfeGj2Bwjkkw&dib_tag=se&keywords=simple+zakat+guide&qid=1738175162&sprefix=simple+zakat%2Caps%2C176&sr=8-1"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-blue-600"
                                    >
                                        {t('about.methodologyLinkText')}
                                    </a>
                                )
                            })}
                        </p>
                    ...
                    <motion.div variants={itemVariants} className="text-sm text-gray-600">
                        <p className="mb-1">
                            <strong>{t('about.contactTitle')}:</strong> {t('about.contactText')}
                        </p>
                    ...
                    <motion.div variants={itemVariants} className="text-xs text-gray-500">
                        {t('about.copyright', { year: new Date().getFullYear() })} {t('common.allRightsReserved')}
                    </motion.div>
                </motion.div>
            </div>
        </div>
