...
describe('Store Validation Tests', () => {
  ...
  describe('validateValueTypes', () => {
    ...
    it('should reject invalid stock structures', () => {
      ...
      expect(validateValueTypes(invalidState)).toBe(false)
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Invalid active stock structure'), expect.any(Object))
    })
  })
  ...
  describe('validateCalculations', () => {
    ...
    it('should detect calculation mismatches', () => {
      ...
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('calculations mismatch'), expect.any(Object))
    })
  })
  ...
  describe('validateValuePropagation', () => {
    ...
    it('should detect total mismatch with items', () => {
      ...
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('breakdown total mismatch'), expect.any(Object))
    })
